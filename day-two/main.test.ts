...
const DATA_FILE_NAME = "./day-two/data.txt";
const DATA_PART_ONE_EXAMPLE_FILE_NAME = "./day-two/data-part-one-example.txt";
const DATA_PART_TWO_EXAMPLE_FILE_NAME = "./day-two/data-part-two-example.txt";
